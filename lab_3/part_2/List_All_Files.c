...
{	
	...
	{		
		...
		*/
		char *argv[3];
		argv[0] =  "ls";									// List all files (command name)
		argv[1] = "-laxo";									// Lists files with permissions, shows hidden files
		argv[2] = NULL;										// Indicates the end of arguments

		execvp(argv[0], argv);								// argv[0] is command name
